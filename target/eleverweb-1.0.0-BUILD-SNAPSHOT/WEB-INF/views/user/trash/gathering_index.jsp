...
<tiles:putAttribute name="title">엘루비 프로젝트 :: 이색 데이트 - 엘루비</tiles:putAttribute>
		...
		<div id="slider">
			<ul>
				...
				<li>
					...
					<img src="${pageContext.request.contextPath}/${list.slider_image}" alt="${list.slider_comment}">
					<c:if test="${list.slider_link != ''}">
					</a>
					</c:if>
				</li>
	...
	<section class="contents">
		...
		<ul class="items">
			...
			<li onclick="javascript:location.href='gathering/${_list.gathering_seq}'">
				<span class="outline"></span>
				<div class="item_cover">
					<div class="photo"><img src="${pageContext.request.contextPath}/${_list.gathering_sub_image}" alt="이색 데이트 엘루비" /></div>
					<div class="item_info">
