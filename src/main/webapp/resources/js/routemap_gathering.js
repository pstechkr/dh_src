...
function searchMark(lat,lng,num){
	...
	// 검색결과를 클릭했을 때 좌표 찍히고, gathering_xxx 에 데이터 들어감.
	$("#gathering_latitude").val(lat);
	$("#gathering_longitude").val(lng);
	$("#gathering_localname1").val(localName1);
	$("#gathering_localname2").val(localName2);
	$("#gathering_localname3").val(localName3);
	$("#gathering_localtitle").val(localTitle);
